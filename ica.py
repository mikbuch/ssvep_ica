# original file location in file system:
# /usr/local/lib/python2.7/dist-packages/mne-0.14.dev0-py2.7.egg/mne/preprocessing/ica.py
#
#
...
#
#
# Modified by Mikolaj Buchwald <mikolaj.buchwald@gmail.com>
#
#
...
class ICA(ContainsMixin):
    ...
    def __init__(self, n_components=None, max_pca_components=None,
        ...
        methods = ('fastica', 'infomax', 'extended-infomax', 'amuse')
    ...
    def _fit(self, data, max_pca_components, fit_type):
        ...
        if self.method == 'fastica':
            ...
            self.unmixing_matrix_ = getattr(ica, 'components_',
                                            'unmixing_matrix_')
        elif self.method == 'amuse':
            from pyseeg.decomposition import AMUSE

            amuse = AMUSE()
            amuse.fit(data[:, sel])
            # get unmixing and add scaling
            self.unmixing_matrix_ = getattr(amuse, 'components_')
