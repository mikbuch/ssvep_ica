...
Additional feature as compared to 04b: write results to file.
+ better data/path management (as intro to 05a)
...
# picks_ssvep = [81, 80, 93, 94, 83, 72, 36 , 120]
picks_ssvep = [8, 9, 10, 15, 16, 17, 21, 22, 23, 28, 29, 30, 37, 38, 39]
...
n_components = len(picks_ssvep)  # if float, select n_components by explained variance of PCA
