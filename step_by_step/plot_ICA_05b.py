...
Function introduced in 05a is used for multiple files.
...
base_dir = '/tmp/stimuli'
data_filenames = 'SSVEP_14Hz_Trial1_SUBJ1.MAT'

output_dir = '/tmp/ICA_noise_removal_fastICA'
